...
const _NAME_LABEL = 'Name on Card';
const _NAME_ERROR = 'Invalid card number';
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                          ...
                          labelText: _NAME_LABEL,
                          hintText: _NAME_LABEL,
                        ),
                        ...
                        validator: (text) =>
                            _validationModel.isNameValid() ? null : _NAME_ERROR,
                        onChanged: (name) {
                          setState(() {
                            _validationModel.name = name;
                          });
                        },
                        onSaved: (text) => widget.card.name = text,
                      ),
                    ),
                    Container(
                      padding: const EdgeInsets.symmetric(vertical: 8),
